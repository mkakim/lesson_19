...
<div align="center" style="border: dashed">
    ...
    <form action="${pageContext.servletContext.contextPath}/user/search" method="get">
        ...
        <td style="font-family: Andalus,Arial; font-size: 20px; color: #2e67ff">${search.login}</td>
        <td style="font-family: Andalus,Arial; font-size: 20px; color: #2e67ff">${search.email}</td>
    </tr>
</div>
